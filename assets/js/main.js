...
function linkAction() {
    const navMenu = document.getElementById('nav-menu')
    //when we click on each mav__link, we remove the show-menu class
    navMenu.classList.remove('show-menu')
}
...
function scrollUp() {
    ...
    // When the scroll is higher than 560 viewport, and the show-scroll class to the a tag with scroll
...
if (selectedTheme) {
    // If the validation is fulfilled, we ask what to know if we activated or deactivated the dark
